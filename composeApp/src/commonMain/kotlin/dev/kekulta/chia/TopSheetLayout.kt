...
fun TopSheetLayout(
    ...
    lockSwipeable: MutableState<Boolean> = remember { mutableStateOf(false) },
    lockDraggable: MutableState<Boolean> = remember { mutableStateOf(false) },
    ...
    BoxWithConstraints(
        ...
        Box(Modifier.fillMaxSize()) {
            Scrim(
                ...
                targetValue = (progress * 5).coerceIn(
                    0f,
                    1f
                ) * (1f - predictiveBackProgress * 0.7f),
            )
        }
